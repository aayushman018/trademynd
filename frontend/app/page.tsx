...
const TelegramAnimation = () => {
  ...
  useEffect(() => {
    ...
    const runSequence = () => {
      ...
      if (slide === 0) {
        // Slide 1: Text Logging (Hinglish)
        // Step 1: Text Message (0.5s)
        // Step 2: Typing (2.0s)
        // Step 3: Bot Card (3.5s)
        ...
        // Slide 2: Media Logging (Audio + Image)
        // Step 1: Voice Note (0.5s)
        // Step 2: Image (1.5s)
        // Step 3: Typing (3.0s)
        // Step 4: Bot Card (4.5s)
        timeouts.push(setTimeout(() => setStep(1), 500));
        ...
        // Slide 3: News (Red Folder)
        // Step 1: Red Folder Alert (0.5s)
        // Step 2: Advisory Note (2.5s)
        timeouts.push(setTimeout(() => setStep(1), 500));
  ...
  return (
    <div className="relative h-[580px] w-full max-w-[420px] mx-auto">
      {/* Telegram Window */}
      <div className="absolute inset-x-0 top-0 bottom-28 overflow-hidden rounded-[24px] border border-[#2A2A2A] bg-[#141414]/95 shadow-2xl backdrop-blur-xl">
        {/* Header */}
        ...
        {/* Chat Area */}
        <div className="relative h-full p-4 space-y-4 overflow-y-auto no-scrollbar pb-20">
                  ...
                  >
                    <div className="w-full max-w-[95%] overflow-hidden rounded-xl border border-[#C9A84C]/30 bg-[#1C1C1C] shadow-lg">
                      ...
                      <div className="grid grid-cols-3 gap-2 p-4 pb-2">
                         <div><p className="text-[10px] text-[#888888]">Entry</p><p className="font-mono text-sm text-[#F0F0F0]">2340.0</p></div>
                         <div><p className="text-[10px] text-[#888888]">Stop</p><p className="font-mono text-sm text-[#C0504A]">2330.0</p></div>
                         <div><p className="text-[10px] text-[#888888]">Target</p><p className="font-mono text-sm text-[#4CAF7A]">2365.0</p></div>
                      </div>
            ...
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              ...
              <div className="mt-8 flex flex-col gap-1">
                <div className="flex flex-wrap items-center gap-4">
                  <Link href="/register" className="glow-button inline-flex items-center justify-center rounded-xl border border-[#C9A84C] bg-[#C9A84C] px-8 py-3.5 text-base font-bold text-[#0C0C0C] transition-all hover:bg-[#C9A84C]/90">
                    Start Free
                  </Link>
