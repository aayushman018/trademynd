...
const TelegramAnimation = () => {
  ...
  useEffect(() => {
    ...
    const runSequence = () => {
      ...
      // 5. Bot Card (5.0s)
      // 6. News Alert (8.0s)
      const times = [500, 1500, 2500, 3500, 5000, 8000];
                ...
                <div className="w-full max-w-[90%] overflow-hidden rounded-2xl rounded-tl-sm border border-[#C0504A]/40 bg-[#1C1C1C]">
                  ...
                  <div className="p-3 space-y-2 text-xs">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-[#F0F0F0]">NFP</span>
                    </div>
                    <div className="flex justify-between">
          ...
          <div className="relative mx-auto grid w-full max-w-7xl gap-16 lg:grid-cols-2 lg:items-start lg:pt-12">
            ...
            >
              ...
              <div className="relative z-10 w-full max-w-[420px]">
                <p className="mb-3 text-xs uppercase tracking-widest text-[#F0F0F0] font-bold">
                ...
                <div className="flex flex-wrap gap-2">
                   {[
                     ...
                     { code: 'IN', label: 'हिंदी' },
                     { code: 'IN', label: 'தமிழ்' },
                     { code: 'IN', label: 'తెలుగు' },
                     { code: 'IN', label: 'मराठी' },
                     { code: 'IN', label: 'ਪੰਜਾਬੀ' }
                   ].map((lang, i) => (
                     <span key={i} className="flex items-center rounded-full border border-[#2A2A2A] bg-[#141414] pl-1 pr-3 py-1 text-xs text-[#F0F0F0] shadow-sm">
                       <span className="mr-2 rounded bg-[#2A2A2A] px-1.5 py-0.5 text-[10px] font-medium text-[#888888]">{lang.code}</span>
                       {lang.label}
                     </span>
                   ))}
                </div>
